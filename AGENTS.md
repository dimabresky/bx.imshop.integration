...
- При включённом журнале писать тело запроса и ответ в `upload/bx.imshop.integration/`. Заголовки и ключ API писать только если включена опция «Писать заголовки и секреты».
