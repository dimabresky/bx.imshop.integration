...
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_TITLE'] = 'Настройки интеграции IMSHOP';
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_ENABLED'] = 'Модуль включён';
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_API_KEY'] = 'Ключ API';
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_API_KEY_HINT'] = 'Пустой ключ закрывает webhook: запросы получают 401.';
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_SITE_ID'] = 'Сайт (LID)';
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_SITE_ID_HINT'] = 'Пустое значение — сайт по умолчанию.';
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_PERSON_TYPE'] = 'Тип плательщика (физлицо)';
$MESS['BX_IMSHOP_INTEGRATION_OPTIONS_PERSON_TYPE_HINT'] = '0 — первый активный тип плательщика сайта.';
